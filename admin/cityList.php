...
<section class="content-header">
        <div class="row">
          ...
          <div class="col-md-6 text-center">
            <a href="cityCreate.php" class="btn btn-default btn-md  bdr5">   
               <span class="glyphicon glyphicon-plus">ADD CITY</span>
            </a> 
          </div>
        </div>  
</section>
                ...
                <div class="table-responsive">
                    <table width="100%" id="datatable" class="table table-hover table-bordered">
                       <thead>
                        ...
                        <?php
                            $state_list=mysql_query("select * from cities");
                            $i=1;
                        ...
                        <tr> 
                            ...
                            <td>
                                <div class="col-md-6 col-sm-12" >
                                    <a href="cityActions.php?did=<?php echo $row['id']?>">
                                        <!-- <img src='imagesold/themeImages/del.png' class="themeIcon" alt="Delete"> -->
                                        <span class="glyphicon glyphicon-trash " style="color:red">Delete</span>
                                    </a> 
                                </div>
                                <div class="col-md-6 col-sm-12" >
                                    <a href="cityEdit.php?edit=<?php echo $row['id']?>">
